...
class OwnerController extends Controller
{
    ...
    public function stok_barang()
    {
        ...
        return Inertia::render('owner/StokBarang', [
            'title' => 'Stok Barang',
    ...
    public function laporan_rekap()
    {
        ...
        return Inertia::render('owner/LaporanRekap', [
            'title' => 'Laporan Rekap',
    ...
    public function detail_laporan_rekap_stok_barang($id)
    {
        ...
        return Inertia::render('owner/rekap/Barang', [
    ...
    public function detail_laporan_rekap_barang_masuk($id)
    {
        ...
        return Inertia::render('owner/rekap/BarangMasuk', [
    ...
    public function detail_laporan_rekap_barang_keluar($id)
    {
        ...
        return Inertia::render('owner/rekap/BarangKeluar', [
