...
export default function Update({ data: data_barang_masuk }) {
    const { supplier, barang } = usePage().props;
    ...
    useEffect(() => {
        setData({
            ...
            supplier_id: data_barang_masuk.supplier_id,
    ...
    useEffect(() => {
        const filterSupplier = supplier.filter(
            (item) => item.kategori_id === data.kategori_id
        );
        setDataSupplier(filterSupplier);
    }, [data.kategori_id]);
    ...
    const handleAddowner = (e) => {
        ...
        post(route("admin.barang-masuk.update"), {
            preserveScroll: true,
            onSuccess: () => {
