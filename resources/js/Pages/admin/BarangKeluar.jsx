import Add from "@/Components/modal/barangKeluar/Add";
import Delete from "@/Components/modal/barangKeluar/Delete";
import Update from "@/Components/modal/barangKeluar/Update";
import Layout from "@/Layouts/Layout";
import moment from "moment";
import React, { useEffect, useState } from "react";
import ReactPaginate from "react-paginate";

export default function BarangKeluar({ data_barang_keluar }) {
    ...
    useEffect(() => {
        ...
        const filteredData = data_barang_keluar?.filter((item) => {
            return (
